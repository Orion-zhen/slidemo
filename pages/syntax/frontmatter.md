...
在每张幻灯片的开头, 可以添加一个可选的 frontmatter 来定义幻灯片的属性. 在第一张幻灯片开头的 frontmatter 称为 headmatter, 它可以配置整个幻灯片的属性. 为了区分 frontmatter 和分页符, 建议除了 headmatter 外, 所有 frontmatter 都应使用 YAML 代码块的格式:
...
> 事实上, slidev 也不支持用 YAML 代码块来定义 headmatter.
